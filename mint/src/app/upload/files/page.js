                ...
                <div className="flex justify-center gap-24 pt-10">
                    <div className="flex flex-col gap-6 max-w-[593px]">
                        <p className="text-3xl leading-[1.5] font-light">
                            Upload the files to attach them to your NFT Passport
                            as assets.
                        </p>
                        <label
                            htmlFor="file-upload"
                        ...
                        >
                            <div className="flex items-center gap-20 border px-6 mt-4 py-3 rounded-lg cursor-pointer">
                    ...
                    <div className="flex flex-col font-light text-2xl gap-3 pt-6">
                        ...
                        {uploadedImages.map((img, i) => (
                            <div
                                key={i}
                                className="max-w-[425px] flex items-center gap-10 border px-6 py-3 rounded-lg transition-all  cursor-pointer"
                            >
