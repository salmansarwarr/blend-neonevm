...
const MintCompleted = ({
    ...
    const url = `https://devnet.neonscan.org/tx/${txHash || ""}`;
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center gap-10 py-14">
                <p
                    className={`text-4xl text-[#15F094] text-center max-w-[935px] leading-[1.5] font-light`}
                >
                    Your NFT Passport had minted successfully
                </p>
                <>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p className="text-sm mt-4">
                                {tokenId && (
                                    ...
                                    >
                                        Token ID: #{tokenId.toString().padStart(3, '0')}
                                    </Link>
                                )}
                            </p>
                            <Link
