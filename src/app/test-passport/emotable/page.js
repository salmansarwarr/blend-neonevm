        ...
        <>
            ...
            <div className="bg-white w-full h-screen text-black flex flex-col items-center gap-10 py-20">
                ...
                {address ? (
                    ...
                    <Connect link={"/test-passport/emotable"} theme="dark" />
                )}
            </div>
        </>
    );
